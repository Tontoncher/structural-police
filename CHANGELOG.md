...
- проверить работу поведения delete при перемещении
- проверить работу с пустым name в группе
- сортировка внутри группы
- oldGroupNamePrefix
- importPathMatch может прийти undefined - это нужно проверить и обернуть
